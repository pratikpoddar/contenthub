...
def user_register(request):
    ...
    if request.method == 'POST':
        ...
        if not checkuser:
            ...
            return render_to_response('chub/register.html', {'page':'register'}, context)
    ...
    if request.method == 'POST':
        ...
        if user:
            if user.is_active:
                ...
                return HttpResponse("Your Chub account is disabled.")
        else:
            ...
            return render_to_response('chub/login.html', {'page' : 'login'}, context)
    else:
        return render_to_response('chub/login.html', {'page' : 'login', 'next_page': next_page }, context)
